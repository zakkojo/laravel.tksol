...
class InterventoController extends Controller {
    ...
    public function edit($id)
    {
        ...
        return view('interventi.edit', compact('intervento', 'cliente', 'rimborsi', 'user', 'contratto'));
    }
	...
	//return view('interventi.' . $intervento->contratto->societa->file_stampa, compact('intervento'));
    ...
    public function visualizzaFattura()
    {
        ...
        if (Input::get('fatturato', '0') == 0)
            $wfatture = ' AND approvato = "1" AND i.fatturabile = 1 AND ore_fatturate <> 0 AND ( i.fatturato IS NULL OR i.fatturato ="" OR i.data_fattura IS NULL OR i.data_fattura = "") ';
    ...
    public function uploadFattureGamma(Request $request)
    {
        ...
        return redirect()->action('InterventoController@visualizzaFattura');
    }
