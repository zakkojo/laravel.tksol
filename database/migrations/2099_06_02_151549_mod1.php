...
class Mod1 extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('intervento', function ($table) {
            ...
            if (Schema::hasColumn('intervento', 'ore_lavorate')) {
                $table->decimal('ore_lavorate', 3, 1)->nullable()->change();
            } else {
                $table->decimal('ore_lavorate', 3, 1)->nullable();
            }
            if (Schema::hasColumn('intervento', 'stato')) {
                $table->dropColumn('stato');
            }
            if (Schema::hasColumn('intervento', 'consulente_id')) {
                $table->dropColumn('consulente_id');
            }
        });
    ...
    public function down()
    {
        ...
        Schema::table('intervento', function ($table) {
            if (Schema::hasColumn('intervento', 'intervento_padre')) {
                $table->dropColumn('intervento_padre');
            }
            if (Schema::hasColumn('intervento', 'user_id_creatore')) {
                $table->dropColumn('user_id_creatore');
            }
            if (Schema::hasColumn('intervento', 'user_id_modifica')) {
                $table->dropColumn('user_id_modifica');
            }
            if (Schema::hasColumn('intervento', 'user_id')) {
                $table->dropColumn('user_id');
            }
            if (Schema::hasColumn('intervento', 'data_accettazione')) {
                $table->dropColumn('data_accettazione');
            }
            if (Schema::hasColumn('intervento', 'data_modifica')) {
                $table->dropColumn('data_modifica');
            }
            if (Schema::hasColumn('intervento', 'storico')) {
                $table->dropColumn('storico');
            }
            if (Schema::hasColumn('intervento', 'sede')) {
                $table->dropColumn('sede');
            }
            if (Schema::hasColumn('intervento', 'ore_lavorate')) {
                $table->dropColumn('ore_lavorate');
            }
            if (Schema::hasColumn('intervento', 'contratto_id')) {
                $table->dropColumn('contratto_id');
            }
            if (Schema::hasColumn('intervento', 'inviato')) {
                $table->dropColumn('inviato');
            }
        });
        ...
        Schema::table('cliente', function ($table) {
            ...
            if (Schema::hasColumn('cliente', 'distanza')) {
        ...
        Schema::table('contatto', function ($table) {
            if (Schema::hasColumn('contatto', 'fax')) {
                $table->dropColumn('fax');
            }
            if (Schema::hasColumn('contatto', 'ruolo')) {
        ...
        Schema::table('contratto', function ($table) {
            if (Schema::hasColumn('contratto', 'rimborsi')) {
