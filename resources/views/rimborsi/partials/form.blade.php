<div class="box-body">
    ...
    <div class="form-group">
        ...
        <select id="tipo_spesa" name="tipo_spesa" class="form-control" style="width: 100%;" tabindex="-1" aria-hidden="true">
    ...
    <div class="form-group">
        <label>Note</label>
        <div id="note" name="note" class="wysihtml5" style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; " placeholder="">
            {{ $rimborso->note or '' }}
        </div>
    </div>
